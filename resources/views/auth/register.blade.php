                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post" action={{route('register')}}>
                                            ...
                                            <div class="form-group">
                                                <input type="text" required="" name="name" placeholder="Name" required autofocus :value="old('name')" autocomplete="name">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" required="" name="email" placeholder="Email" required autofocus :value="old('email')" autocomplete="email">
                                            </div>
                                            <div class="form-group">

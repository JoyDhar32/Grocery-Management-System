                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 primary-sidebar sticky-sidebar">
                            ...
                            <div class="widget-category mb-30">
                                ...
                                <ul class="categories">
                                    @foreach($categories as $category)                          
                                     <li><a href="{{route('product.category',['slug'=>$category->slug])}}">{{$category->name}}</a></li>                                  @endforeach
                                </ul>
                            </div>
                            <!-- Fillter By Price -->
                            ...
                            <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                                <div class="widget-header position-relative mb-20 pb-10">
                                    <h5 class="widget-title mb-10">Customers Choice</h5>
                                ...
                                <div class="single-post clearfix">
                                    <div class="image">
                                        <img class="default-img" src="{{asset('assets/imgs/shop') }}/{{ $best_sell->images }}-1.jpg" alt="Product Image">
                                    </div>
                                    <div class="content pt-10">
                                        <h5><a href="{{route('product.details',['slug'=>$best_sell->slug])}}">{{$best_sell->name}}</a></h5>
                                        <p class="price mb-0 mt-5">{{$best_sell->regular_price}}</p>

                            ...
                            <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('product.details', ['slug' => $item->model->slug]) }}">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/') }}/{{ $item->model->images }}-1.jpg"
                                                alt="{{ $item->model->name }}">
                                            <img class="hover-img"
                                                src="{{ asset('assets/imgs/shop/') }}/{{ $item->model->images }}-2.jpg"
                                                alt="{{ $item->model->name }}">
                                        </a>
                                    </div>
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <div class="product-price">
                                        ...
                                        <span class="old-price"> {{$item->model->old_price}}$php a </span>
                                    </div>
                                    <div class="product-action-1 show">
                                        ...
                                        href="#" wire:click.prevent="store({{$item->model->id,}},'{{$item->model->name}}',{{$item->model->regular_price}})"><i class="fi-rs-shopping-bag-add"></i></a> --}}
                                    </div>
                                </div>
                            </div>
                        </div>

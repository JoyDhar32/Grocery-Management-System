...
<div class="alart alert-success"> <strong>{{Session::get('success_message')}}</strong></div>
                                    @endif
                                   @foreach(Cart::instance('cart')->content() as $item)
                                    <tr>
                                        <td class="image product-thumbnail"><img src="{{asset('assets/imgs/shop/') }}/{{ $item->model->images }}-1.jpg" alt="#"></td>
                                        <td class="product-des product-name">
                                            <h5 class="product-name" style="font-weight:bold;color:#F15412">{{$item->model->name}}</h5>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="cart_total_label">GST (1%)</td>
                ...
                @else
                <p class="alert alert-warning"style="font-weight:bold;">No Item in Cart</p>
                @endif
